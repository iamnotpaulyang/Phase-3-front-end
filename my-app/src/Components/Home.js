  ...
  const handleSubmit = (e) => {
    ...
    <div className="home">
      <div className="about">
        ...
        <h4>Tartarus: is the region of the Underworld where the primordial Titans are imprisoned and the souls of the unrighteous are given ironic punishments for eternity. This is the region where the death-cheating king Sisyphus is forced to push a boulder uphill for all eternity. Environmentally, the maps of Tartarus are dark and gloomy, filled with spike traps, the souls of the damned, and where Megaera awaits her next victim.</h4>
        <h4>Asphodel: is where virtuous souls who lived peaceful lives spend eternity in a verdant meadow... or at least, that's how it was in the original Greek myths. In-game, an overflowing river of lava transformed Asphodel into a scorched volcanic landscape, with a hydra at its heart. </h4>
        <h4>Elysium: is a paradise for souls who died heroic deaths. The game depicts Hades as a cool, soothing location filled with moss and crystals, and many of the enemies therein are the spirits of warriors seeking to relive their glory days. Famous heroes of Greek Myth such as Patroclus, Theseus, and the Mintotaur Asterius can be found here.</h4>
        <h4>Temple of Styx: River Styx, the body of water which separates the Underworld from the surface. This realm of the Underworld has the look of a grimy basement dungeon, and escaping it leads to the final map of the game (a snow-covered ruin) and the current final boss of the game, Lord Hades himself.</h4>
